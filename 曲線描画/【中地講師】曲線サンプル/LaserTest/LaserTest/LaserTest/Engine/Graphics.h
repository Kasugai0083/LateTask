...
void DrawUVMappingTexture(float x, float y, Texture* texture_data, float texture_x, float texture_y, float sprite_width, float sprite_y);
...
//void DrawLine(Vec2 start, Vec2 end, DWORD color);
